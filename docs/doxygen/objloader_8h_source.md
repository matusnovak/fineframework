...
**[Go to the documentation of this file.](objloader_8h.md)**
Source: `include/ffw/media/objloader.h`
...
namespace ffw{
    ...
    inline bool readObj(const std::string& path, ffw::Vbo* vbo, GLenum type = GL_STATIC_DRAW) {
        ...
        if (!vbo->create(vertices, numVertices * 8 * sizeof(float), type)) {
