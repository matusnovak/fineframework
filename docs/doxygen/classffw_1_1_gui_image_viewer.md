---
search:
    keywords: ['ffw::GuiImageViewer', 'Style', 'GuiImageViewer', '~GuiImageViewer', 'setImage', 'setSubsection', 'setMirror', 'getImage', 'getSubsection', 'getMirror', 'setLabel', 'getLabel', 'getMinimumWrapSize', 'setStyle', 'GuiWidget', 'GuiWidget', 'GuiWidget', 'swap', '~GuiWidget', 'setSize', 'setSize', 'setPos', 'getPos', 'getSize', 'getVisibleContentSize', 'getVisibleContentPos', 'getInnerContentSize', 'getInnerContentPos', 'getAbsolutePos', 'setOffset', 'getOffset', 'setPadding', 'setPadding', 'setPadding', 'setMargin', 'setMargin', 'setMargin', 'getPadding', 'getMargin', 'getPadding', 'getMargin', 'setMarginTop', 'setMarginRight', 'setMarginBottom', 'setMarginLeft', 'setPaddingTop', 'setPaddingRight', 'setPaddingBottom', 'setPaddingLeft', 'getPaddingInPixels', 'getMarginInPixels', 'setAlign', 'getAlign', 'setWrap', 'getWrap', 'setID', 'getID', 'update', 'render', 'shouldRedraw', 'redraw', 'invalidate', 'setParent', 'getParent', 'hasHover', 'hasFocus', 'setFocus', 'setHover', 'setDisabled', 'setHidden', 'setIgnoreUserInput', 'hide', 'show', 'isHidden', 'isDisabled', 'setFont', 'getFont', 'getCurrentFont', 'getMousePos', 'getMinimumWrapSize', 'getOuterWrapSize', 'findByID', 'addEventCallback', 'addEventCallback', 'addEventCallback', 'setTheme', 'setStyleGroup', 'getStyleGroup', 'getCurrentStyle', 'getCurrentStyle', 'getRealSize', 'getRealSizeWithMargin', 'getRealPos', 'setLineHeight', 'getLineHeight', 'setDefaults', 'getWindow', 'getWindow', 'setToggleFocus', 'setStickyFocus', 'setDropFocus', 'setDefaultFocus', 'getFocusType', 'getAllWidgets', 'pushEvent', 'operator=', 'operator=']
---
...
|Type|Name|
|-----|-----|
||[**GuiImageViewer**](classffw_1_1_gui_image_viewer.md#1aa0e3ccefa3fa2cc77d7edbf39d41b604) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context, const **[GuiImage](classffw_1_1_gui_image.md)** \* image) |
|virtual |[**~GuiImageViewer**](classffw_1_1_gui_image_viewer.md#1ac26a419a4f51e706a466edfccea432c3) () = default |
|void|[**setImage**](classffw_1_1_gui_image_viewer.md#1a8d939f0b7f5cc298ff597f42a004ef33) (const **[GuiImage](classffw_1_1_gui_image.md)** \* image) |
|void|[**setSubsection**](classffw_1_1_gui_image_viewer.md#1a653b2a640c1b66d52a7807d07a0dc636) (int posx, int posy, int width, int height) |
|void|[**setMirror**](classffw_1_1_gui_image_viewer.md#1af88d97c8cab36324dc954240421bf59c) (bool mirrorX, bool mirrorY) |
|const **[GuiImage](classffw_1_1_gui_image.md)** \*|[**getImage**](classffw_1_1_gui_image_viewer.md#1a82b45b8c345bc5e11e4adc1674a885c0) () const |
|const **[ffw::Vec4i](group__math_.md#ga3bd7b708561d6e2db0e66a1dd4177400)**|[**getSubsection**](classffw_1_1_gui_image_viewer.md#1ab96ceccb9fd4847464148b16afa73b59) () const |
|const **[ffw::Vec2](structffw_1_1_vec2.md)**< bool >|[**getMirror**](classffw_1_1_gui_image_viewer.md#1aff92d4cad4b0cf345f6833806c499b9e) () const |
|void|[**setLabel**](classffw_1_1_gui_image_viewer.md#1a23c411a4d916257452eaccaf2fa5de11) (const std::string & label) |
|const std::string &|[**getLabel**](classffw_1_1_gui_image_viewer.md#1a2d2026077c14f9a6cb76379c150480a1) () const |
|virtual **[ffw::Vec2f](group__math_.md#ga44573357c25b7969b4391ca0ae427636)**|[**getMinimumWrapSize**](classffw_1_1_gui_image_viewer.md#1a4fc77d878729cf5ed00ba2f071996472) () override |
|void|[**setStyle**](classffw_1_1_gui_image_viewer.md#1a17167e9c0b7ca96bbccb9f7a99bd907b) (const **[GuiImageViewer::Style](structffw_1_1_gui_image_viewer_1_1_style.md)** \* style, bool defaults = false) |
...
### function <a id="1aa0e3ccefa3fa2cc77d7edbf39d41b604" href="#1aa0e3ccefa3fa2cc77d7edbf39d41b604">GuiImageViewer</a>
...
### function <a id="1ac26a419a4f51e706a466edfccea432c3" href="#1ac26a419a4f51e706a466edfccea432c3">~GuiImageViewer</a>
...
### function <a id="1a8d939f0b7f5cc298ff597f42a004ef33" href="#1a8d939f0b7f5cc298ff597f42a004ef33">setImage</a>
...
### function <a id="1a653b2a640c1b66d52a7807d07a0dc636" href="#1a653b2a640c1b66d52a7807d07a0dc636">setSubsection</a>
...
### function <a id="1af88d97c8cab36324dc954240421bf59c" href="#1af88d97c8cab36324dc954240421bf59c">setMirror</a>
...
### function <a id="1a82b45b8c345bc5e11e4adc1674a885c0" href="#1a82b45b8c345bc5e11e4adc1674a885c0">getImage</a>
...
### function <a id="1ab96ceccb9fd4847464148b16afa73b59" href="#1ab96ceccb9fd4847464148b16afa73b59">getSubsection</a>

```cpp
const ffw::Vec4i ffw::GuiImageViewer::getSubsection () const
```



### function <a id="1aff92d4cad4b0cf345f6833806c499b9e" href="#1aff92d4cad4b0cf345f6833806c499b9e">getMirror</a>

```cpp
const ffw::Vec2< bool > ffw::GuiImageViewer::getMirror () const
```



### function <a id="1a23c411a4d916257452eaccaf2fa5de11" href="#1a23c411a4d916257452eaccaf2fa5de11">setLabel</a>
...
### function <a id="1a2d2026077c14f9a6cb76379c150480a1" href="#1a2d2026077c14f9a6cb76379c150480a1">getLabel</a>
...
### function <a id="1a4fc77d878729cf5ed00ba2f071996472" href="#1a4fc77d878729cf5ed00ba2f071996472">getMinimumWrapSize</a>

```cpp
virtual ffw::Vec2f ffw::GuiImageViewer::getMinimumWrapSize ()
```

Overrides **[GuiWidget::getMinimumWrapSize](classffw_1_1_gui_widget.md#1a9ab138b320453c0361ef35ba198d2a9a)**


### function <a id="1a17167e9c0b7ca96bbccb9f7a99bd907b" href="#1a17167e9c0b7ca96bbccb9f7a99bd907b">setStyle</a>
