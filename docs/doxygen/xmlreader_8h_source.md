...
**[Go to the documentation of this file.](xmlreader_8h.md)**
Source: `include/ffw/data/xmlreader.h`
...
namespace ffw {
    ...
    ffw::Any FFW_API decodeXml(const char* input);
    ffw::Any FFW_API decodeXml(const std::string& input);
    ffw::Any FFW_API decodeXmlFile(const std::string& path);
};
