---
search:
    keywords: ['ffw::GuiScrollBar::ButtonBottom', 'Style', 'ButtonBottom', '~ButtonBottom', 'setStyle', 'GuiButton', '~GuiButton', 'setLabel', 'getLabel', 'getMinimumWrapSize', 'setStyle', 'GuiWidget', 'GuiWidget', 'GuiWidget', 'swap', '~GuiWidget', 'setSize', 'setSize', 'setPos', 'getPos', 'getSize', 'getVisibleContentSize', 'getVisibleContentPos', 'getInnerContentSize', 'getInnerContentPos', 'getAbsolutePos', 'setOffset', 'getOffset', 'setPadding', 'setPadding', 'setPadding', 'setMargin', 'setMargin', 'setMargin', 'getPadding', 'getMargin', 'getPadding', 'getMargin', 'setMarginTop', 'setMarginRight', 'setMarginBottom', 'setMarginLeft', 'setPaddingTop', 'setPaddingRight', 'setPaddingBottom', 'setPaddingLeft', 'getPaddingInPixels', 'getMarginInPixels', 'setAlign', 'getAlign', 'setWrap', 'getWrap', 'setID', 'getID', 'update', 'render', 'shouldRedraw', 'redraw', 'invalidate', 'setParent', 'getParent', 'hasHover', 'hasFocus', 'setFocus', 'setHover', 'setDisabled', 'setHidden', 'setIgnoreUserInput', 'hide', 'show', 'isHidden', 'isDisabled', 'setFont', 'getFont', 'getCurrentFont', 'getMousePos', 'getMinimumWrapSize', 'getOuterWrapSize', 'findByID', 'addEventCallback', 'addEventCallback', 'addEventCallback', 'setTheme', 'setStyleGroup', 'getStyleGroup', 'getCurrentStyle', 'getCurrentStyle', 'getRealSize', 'getRealSizeWithMargin', 'getRealPos', 'setLineHeight', 'getLineHeight', 'setDefaults', 'getWindow', 'getWindow', 'setToggleFocus', 'setStickyFocus', 'setDropFocus', 'setDefaultFocus', 'getFocusType', 'getAllWidgets', 'pushEvent', 'operator=', 'operator=']
---

# class ffw::GuiScrollBar::ButtonBottom



Inherits the following classes: **[ffw::GuiButton](classffw_1_1_gui_button.md)**
...
|Type|Name|
|-----|-----|
||[**ButtonBottom**](classffw_1_1_gui_scroll_bar_1_1_button_bottom.md#1a16f2f3dd28c5fe83ca95af32c3edffea) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context) |
|virtual |[**~ButtonBottom**](classffw_1_1_gui_scroll_bar_1_1_button_bottom.md#1a8418aa01f2436973d44da743f313be1d) () = default |
|void|[**setStyle**](classffw_1_1_gui_scroll_bar_1_1_button_bottom.md#1a1edd0ab8b3c83a91beeb83030460c622) (const **[ButtonBottom::Style](structffw_1_1_gui_scroll_bar_1_1_button_bottom_1_1_style.md)** \* style, bool defaults = false) |
...
### function <a id="1a16f2f3dd28c5fe83ca95af32c3edffea" href="#1a16f2f3dd28c5fe83ca95af32c3edffea">ButtonBottom</a>

```cpp
ffw::GuiScrollBar::ButtonBottom::ButtonBottom (
    GuiWindow * context
)
```
...
### function <a id="1a8418aa01f2436973d44da743f313be1d" href="#1a8418aa01f2436973d44da743f313be1d">~ButtonBottom</a>

```cpp
virtual ffw::GuiScrollBar::ButtonBottom::~ButtonBottom () = default
```



### function <a id="1a1edd0ab8b3c83a91beeb83030460c622" href="#1a1edd0ab8b3c83a91beeb83030460c622">setStyle</a>

```cpp
void ffw::GuiScrollBar::ButtonBottom::setStyle (
