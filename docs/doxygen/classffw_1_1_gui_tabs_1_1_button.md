---
search:
    keywords: ['ffw::GuiTabs::Button', 'Style', 'Button', '~Button', 'setStyle', 'getTargetWidget', 'GuiButtonToggle', '~GuiButtonToggle', 'setValue', 'getValue', 'GuiButton', '~GuiButton', 'setLabel', 'getLabel', 'getMinimumWrapSize', 'setStyle', 'GuiWidget', 'GuiWidget', 'GuiWidget', 'swap', '~GuiWidget', 'setSize', 'setSize', 'setPos', 'getPos', 'getSize', 'getVisibleContentSize', 'getVisibleContentPos', 'getInnerContentSize', 'getInnerContentPos', 'getAbsolutePos', 'setOffset', 'getOffset', 'setPadding', 'setPadding', 'setPadding', 'setMargin', 'setMargin', 'setMargin', 'getPadding', 'getMargin', 'getPadding', 'getMargin', 'setMarginTop', 'setMarginRight', 'setMarginBottom', 'setMarginLeft', 'setPaddingTop', 'setPaddingRight', 'setPaddingBottom', 'setPaddingLeft', 'getPaddingInPixels', 'getMarginInPixels', 'setAlign', 'getAlign', 'setWrap', 'getWrap', 'setID', 'getID', 'update', 'render', 'shouldRedraw', 'redraw', 'invalidate', 'setParent', 'getParent', 'hasHover', 'hasFocus', 'setFocus', 'setHover', 'setDisabled', 'setHidden', 'setIgnoreUserInput', 'hide', 'show', 'isHidden', 'isDisabled', 'setFont', 'getFont', 'getCurrentFont', 'getMousePos', 'getMinimumWrapSize', 'getOuterWrapSize', 'findByID', 'addEventCallback', 'addEventCallback', 'addEventCallback', 'setTheme', 'setStyleGroup', 'getStyleGroup', 'getCurrentStyle', 'getCurrentStyle', 'getRealSize', 'getRealSizeWithMargin', 'getRealPos', 'setLineHeight', 'getLineHeight', 'setDefaults', 'getWindow', 'getWindow', 'setToggleFocus', 'setStickyFocus', 'setDropFocus', 'setDefaultFocus', 'getFocusType', 'getAllWidgets', 'pushEvent', 'operator=', 'operator=']
---
...
Inherits the following classes: **[ffw::GuiButtonToggle](classffw_1_1_gui_button_toggle.md)**
...
|Type|Name|
|-----|-----|
||[**Button**](classffw_1_1_gui_tabs_1_1_button.md#1aadbdcf8edb4e3bdefd21438cb379e9dc) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context, const std::string & label, **[GuiWidget](classffw_1_1_gui_widget.md)** \* targetWidget) |
|virtual |[**~Button**](classffw_1_1_gui_tabs_1_1_button.md#1acb712dc5fe9b985444a36caeb642a8f9) () = default |
|void|[**setStyle**](classffw_1_1_gui_tabs_1_1_button.md#1af70c7cd2040ea8388e55c5d9434dc4f6) (const **[Button::Style](structffw_1_1_gui_tabs_1_1_button_1_1_style.md)** \* style, bool defaults = false) |
|**[GuiWidget](classffw_1_1_gui_widget.md)** \*|[**getTargetWidget**](classffw_1_1_gui_tabs_1_1_button.md#1a34a04a93daf02026c3bf92179b626041) () const |


#### Public Functions inherited from [ffw::GuiButtonToggle](classffw_1_1_gui_button_toggle.md)

|Type|Name|
|-----|-----|
||[**GuiButtonToggle**](classffw_1_1_gui_button_toggle.md#1af33c6e84ced5e4a1f64da2d5837e353f) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context, const std::string & label) |
|virtual |[**~GuiButtonToggle**](classffw_1_1_gui_button_toggle.md#1a07de82e458e172f14e63e0423fba4249) () = default |
|void|[**setValue**](classffw_1_1_gui_button_toggle.md#1a59cb109e6dddb4888b04644974bfbf6b) (bool value) |
|bool|[**getValue**](classffw_1_1_gui_button_toggle.md#1a7ebf395c037a74efb5fe254ee8cf9db6) () const |


#### Public Functions inherited from [ffw::GuiButton](classffw_1_1_gui_button.md)

|Type|Name|
|-----|-----|
||[**GuiButton**](classffw_1_1_gui_button.md#1a43c21b4f5d4a3866b973318a44fac0a8) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context, const std::string & label) |
|virtual |[**~GuiButton**](classffw_1_1_gui_button.md#1a89de7869fb445f8969c0196c9d61ab15) () = default |
|void|[**setLabel**](classffw_1_1_gui_button.md#1a7ef6f7f0ef78cb03918ffccf186f9fd3) (const std::string & label) |
|const std::string &|[**getLabel**](classffw_1_1_gui_button.md#1a93e243474d9652aa7e91809ce2be2c1c) () const |
|virtual **[ffw::Vec2f](group__math_.md#ga44573357c25b7969b4391ca0ae427636)**|[**getMinimumWrapSize**](classffw_1_1_gui_button.md#1a9c2b9ac2ca539c469db5bdd3fb513110) () override |
|void|[**setStyle**](classffw_1_1_gui_button.md#1a3eb622fd694c03d5f9b3fdba5f767db9) (const **[GuiButton::Style](structffw_1_1_gui_button_1_1_style.md)** \* style, bool defaults = false) |
...
### function <a id="1aadbdcf8edb4e3bdefd21438cb379e9dc" href="#1aadbdcf8edb4e3bdefd21438cb379e9dc">Button</a>
...
### function <a id="1acb712dc5fe9b985444a36caeb642a8f9" href="#1acb712dc5fe9b985444a36caeb642a8f9">~Button</a>
...
### function <a id="1af70c7cd2040ea8388e55c5d9434dc4f6" href="#1af70c7cd2040ea8388e55c5d9434dc4f6">setStyle</a>
...
### function <a id="1a34a04a93daf02026c3bf92179b626041" href="#1a34a04a93daf02026c3bf92179b626041">getTargetWidget</a>
