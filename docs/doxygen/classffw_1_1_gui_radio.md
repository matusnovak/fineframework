---
search:
    keywords: ['ffw::GuiRadio', 'Button', 'Style', 'Value', 'GuiRadio', '~GuiRadio', 'setLabel', 'getLabel', 'getBaseValue', 'setValue', 'getValue', 'resetValue', 'assignValue', 'setButtonSize', 'getButton', 'getButton', 'getMinimumWrapSize', 'setStyle', 'GuiWidget', 'GuiWidget', 'GuiWidget', 'swap', '~GuiWidget', 'setSize', 'setSize', 'setPos', 'getPos', 'getSize', 'getVisibleContentSize', 'getVisibleContentPos', 'getInnerContentSize', 'getInnerContentPos', 'getAbsolutePos', 'setOffset', 'getOffset', 'setPadding', 'setPadding', 'setPadding', 'setMargin', 'setMargin', 'setMargin', 'getPadding', 'getMargin', 'getPadding', 'getMargin', 'setMarginTop', 'setMarginRight', 'setMarginBottom', 'setMarginLeft', 'setPaddingTop', 'setPaddingRight', 'setPaddingBottom', 'setPaddingLeft', 'getPaddingInPixels', 'getMarginInPixels', 'setAlign', 'getAlign', 'setWrap', 'getWrap', 'setID', 'getID', 'update', 'render', 'shouldRedraw', 'redraw', 'invalidate', 'setParent', 'getParent', 'hasHover', 'hasFocus', 'setFocus', 'setHover', 'setDisabled', 'setHidden', 'setIgnoreUserInput', 'hide', 'show', 'isHidden', 'isDisabled', 'setFont', 'getFont', 'getCurrentFont', 'getMousePos', 'getMinimumWrapSize', 'getOuterWrapSize', 'findByID', 'addEventCallback', 'addEventCallback', 'addEventCallback', 'setTheme', 'setStyleGroup', 'getStyleGroup', 'getCurrentStyle', 'getCurrentStyle', 'getRealSize', 'getRealSizeWithMargin', 'getRealPos', 'setLineHeight', 'getLineHeight', 'setDefaults', 'getWindow', 'getWindow', 'setToggleFocus', 'setStickyFocus', 'setDropFocus', 'setDefaultFocus', 'getFocusType', 'getAllWidgets', 'pushEvent', 'operator=', 'operator=']
---
...
|Type|Name|
|-----|-----|
||[**GuiRadio**](classffw_1_1_gui_radio.md#1a8a70da353df8f6e381fff43e93c7468b) (**[GuiWindow](classffw_1_1_gui_window.md)** \* context, const std::string & label, int base, **[GuiRadio](classffw_1_1_gui_radio.md)** \* other = nullptr) |
|virtual |[**~GuiRadio**](classffw_1_1_gui_radio.md#1a5ba3dd0c09c5a22ad7a3f3cc439aa920) () |
|void|[**setLabel**](classffw_1_1_gui_radio.md#1aa038e80bd2685eea2b1bfff46b02dc8e) (const std::string & label) |
|const std::string &|[**getLabel**](classffw_1_1_gui_radio.md#1a49d65d556f766d6bd71d2f9b825790f6) () const |
|int|[**getBaseValue**](classffw_1_1_gui_radio.md#1a2860e6f7921bec80898ffb92cd2c6d1d) () const |
|void|[**setValue**](classffw_1_1_gui_radio.md#1a9f62cd1bce06ddc1f53cc9ec6a90c942) (int value) |
|int|[**getValue**](classffw_1_1_gui_radio.md#1a78fd0530217fdaf43a5dc6e54f065d25) () const |
|void|[**resetValue**](classffw_1_1_gui_radio.md#1aaa75ea0521a38a6bb6c144cd67a50b47) () |
|void|[**assignValue**](classffw_1_1_gui_radio.md#1a134e862a4b87df7dad744ac35105aba0) (bool value) |
|void|[**setButtonSize**](classffw_1_1_gui_radio.md#1af936ec42c544127745c65cd78c4fdc88) (float width) |
|const **[GuiRadio::Button](classffw_1_1_gui_radio_1_1_button.md)** \*|[**getButton**](classffw_1_1_gui_radio.md#1ad0c2cc394b7cd59006b3b28cfc418e5a) () const |
|**[GuiRadio::Button](classffw_1_1_gui_radio_1_1_button.md)** \*|[**getButton**](classffw_1_1_gui_radio.md#1a721cb677c093e74d9830810ec6d5b480) () |
|virtual **[ffw::Vec2f](group__math_.md#ga44573357c25b7969b4391ca0ae427636)**|[**getMinimumWrapSize**](classffw_1_1_gui_radio.md#1a7d8142a49cdf8b9cdee08c335eb0f416) () override |
|void|[**setStyle**](classffw_1_1_gui_radio.md#1ad750563201d4a4e9a4a30c42cecd1563) (const **[GuiRadio::Style](structffw_1_1_gui_radio_1_1_style.md)** \* style, bool defaults = false) |
...
### function <a id="1a8a70da353df8f6e381fff43e93c7468b" href="#1a8a70da353df8f6e381fff43e93c7468b">GuiRadio</a>
...
### function <a id="1a5ba3dd0c09c5a22ad7a3f3cc439aa920" href="#1a5ba3dd0c09c5a22ad7a3f3cc439aa920">~GuiRadio</a>
...
### function <a id="1aa038e80bd2685eea2b1bfff46b02dc8e" href="#1aa038e80bd2685eea2b1bfff46b02dc8e">setLabel</a>
...
### function <a id="1a49d65d556f766d6bd71d2f9b825790f6" href="#1a49d65d556f766d6bd71d2f9b825790f6">getLabel</a>
...
### function <a id="1a2860e6f7921bec80898ffb92cd2c6d1d" href="#1a2860e6f7921bec80898ffb92cd2c6d1d">getBaseValue</a>
...
### function <a id="1a9f62cd1bce06ddc1f53cc9ec6a90c942" href="#1a9f62cd1bce06ddc1f53cc9ec6a90c942">setValue</a>
...
### function <a id="1a78fd0530217fdaf43a5dc6e54f065d25" href="#1a78fd0530217fdaf43a5dc6e54f065d25">getValue</a>
...
### function <a id="1aaa75ea0521a38a6bb6c144cd67a50b47" href="#1aaa75ea0521a38a6bb6c144cd67a50b47">resetValue</a>
...
### function <a id="1a134e862a4b87df7dad744ac35105aba0" href="#1a134e862a4b87df7dad744ac35105aba0">assignValue</a>
...
### function <a id="1af936ec42c544127745c65cd78c4fdc88" href="#1af936ec42c544127745c65cd78c4fdc88">setButtonSize</a>
...
### function <a id="1ad0c2cc394b7cd59006b3b28cfc418e5a" href="#1ad0c2cc394b7cd59006b3b28cfc418e5a">getButton</a>
...
### function <a id="1a721cb677c093e74d9830810ec6d5b480" href="#1a721cb677c093e74d9830810ec6d5b480">getButton</a>
...
### function <a id="1a7d8142a49cdf8b9cdee08c335eb0f416" href="#1a7d8142a49cdf8b9cdee08c335eb0f416">getMinimumWrapSize</a>

```cpp
virtual ffw::Vec2f ffw::GuiRadio::getMinimumWrapSize ()
```

Overrides **[GuiWidget::getMinimumWrapSize](classffw_1_1_gui_widget.md#1a9ab138b320453c0361ef35ba198d2a9a)**


### function <a id="1ad750563201d4a4e9a4a30c42cecd1563" href="#1ad750563201d4a4e9a4a30c42cecd1563">setStyle</a>
