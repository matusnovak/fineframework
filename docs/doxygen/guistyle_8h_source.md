...
**[Go to the documentation of this file.](guistyle_8h.md)**
Source: `include/ffw/gui/guistyle.h`
...
namespace ffw {
    ...
    public:
        GuiUnits2D():ffw::Vec2<GuiUnits>(guiPixels(0), guiPixels(0)){
        }

        GuiUnits2D(const GuiUnits x, const GuiUnits y):ffw::Vec2<GuiUnits>(x, y) {
        }

        inline ffw::Vec2f toReal(const ffw::Vec2f& size) const {
