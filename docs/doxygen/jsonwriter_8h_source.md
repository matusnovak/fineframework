...
**[Go to the documentation of this file.](jsonwriter_8h.md)**
Source: `include/ffw/data/jsonwriter.h`
...
namespace ffw{
    ...
    std::string FFW_API encodeJson(const ffw::Any& input, const char* indent = NULL, bool escape = false);
    bool FFW_API encodeJsonFile(const std::string& path, const ffw::Any& input, const char* indent = NULL, bool escape = false);
};
