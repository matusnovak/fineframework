...
# guiwidget.h File Reference

**[Go to the documentation of this file.](guiwidget_8h.md)**
Source: `include/ffw/gui/guiwidget.h`
...
namespace ffw {
    ...
    protected:
        ...
        virtual void eventPos(const ffw::Vec2f& pos);
        virtual void eventSize(const ffw::Vec2f& size);
        virtual void eventHover(bool gained);
        virtual void eventFocus(bool gained);
        virtual void eventMouse(const ffw::Vec2f& mousePos);
        virtual bool eventScroll(const ffw::Vec2f& scroll);
        virtual void eventMouseButton(ffw::MouseButton button, ffw::Mode mode);
        virtual void eventText(uint32_t chr);
        virtual void eventKey(ffw::Key key, ffw::Mode mode);
    ...
    private:
        ...
        void realignWidgetsHorizontally(size_t start, size_t end, const ffw::Vec2f& contentSize);
        void realignWidgetsHorizontallyEnd(size_t start, size_t end, const ffw::Vec2f& contentSize, const ffw::Vec2f& totalSize);
        void realignWidgetsVertically(size_t start, size_t end, const ffw::Vec2f& contentSize);
        void realignWidgetsVerticallyEnd(size_t start, size_t end, const ffw::Vec2f& contentSize, const ffw::Vec2f& totalSize);
        ffw::Vec2f sizeReal;
        ffw::Vec2f posReal;
        ffw::GuiUnits2D size;
        ffw::GuiUnits2D pos;
