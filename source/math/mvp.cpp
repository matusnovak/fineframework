...
///=============================================================================
ffw::Mat4x4f ffw::MakeProjectionMatrix(float FieldOfView, float Aspect, float Near, float Far) {
...
///=============================================================================
ffw::Mat4x4f ffw::MakeLookAtMatrix(const Vec3f& Eyes, const Vec3f& Target, const Vec3f& UpVector) {
	Mat4x4f mat;
...
///=============================================================================
ffw::Mat4x4f ffw::MakeFpsCameraMatrix(const Vec3f& Eyes, float Pitch, float Yaw) {
