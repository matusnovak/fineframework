...
#else
		case ffw::ImageType::RED_RGTC1: {
			return OpenGLImageType(GL_COMPRESSED_RED_RGTC1_EXT, GL_R, GL_UNSIGNED_BYTE);
		};
		case ffw::ImageType::RED_GREEN_RGTC2: {
			return OpenGLImageType(GL_COMPRESSED_RED_GREEN_RGTC2_EXT, GL_RG, GL_UNSIGNED_BYTE);
		};
		case ffw::ImageType::SIGNED_RED_RGTC1: {
			return OpenGLImageType(GL_COMPRESSED_SIGNED_RED_RGTC1_EXT, GL_R, GL_UNSIGNED_BYTE);
		};
		case ffw::ImageType::SIGNED_RED_GREEN_RGTC2: {
			return OpenGLImageType(GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT, GL_RG, GL_UNSIGNED_BYTE);
		};
#endif
