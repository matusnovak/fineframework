...
#define WINDOW_COLOR rgb(0xFCFAFD)
#define COLOR_WHITE rgb(0xFFFFFF)
#define COLOR_BLACK rgb(0x000000)
#define COLOR_TRANSPARENT rgba(0xFFFFFF00)

#define TEXT_COLOR_NORMAL rgb(0x2E2E2E)
#define TEXT_COLOR_HOVER rgb(0x2E2E2E)
#define TEXT_COLOR_FOCUS rgb(0xFCFAFD)
#define TEXT_COLOR_DISABLED rgb(0x989898)
#define FUNCTION_COLOR_DEFAULT rgb(0xFFFFFF)

#define BACKGROUND_COLOR_NORMAL rgb(0xE9E6EA)
#define BACKGROUND_COLOR_HOVER rgb(0xDEDCDF)
#define BACKGROUND_COLOR_FOCUS rgb(0x6E6E6E)
#define BACKGROUND_COLOR_DISABLED rgb(0xE9E8EA)

#define BORDER_COLOR_NORMAL rgb(0xB4B5B6)
#define BORDER_COLOR_HOVER rgb(0xB4B5B6)
#define BORDER_COLOR_FOCUS rgb(0x3497FD)
#define BORDER_COLOR_DISABLED rgb(0xC9C9C9)
#define BORDER_COLOR_BOX rgb(0xDDDEDF)
...
#define TEXT_COLOR_P_NORMAL rgb(0xFCFAFD)
#define TEXT_COLOR_P_HOVER rgb(0xFCFAFD)
#define TEXT_COLOR_P_FOCUS rgb(0xFCFAFD)
#define TEXT_COLOR_P_DISABLED rgb(0x989898)

#define BACKGROUND_P_COLOR_NORMAL rgb(0x5CA2E8)
#define BACKGROUND_P_COLOR_HOVER rgb(0x3497FD)
#define BACKGROUND_P_COLOR_FOCUS rgb(0x2875C1)
#define BACKGROUND_P_COLOR_DISABLED rgb(0xEFF0F1)
...
ffw::GuiThemeFlatLight::GuiThemeFlatLight() {
    ...
    radio = GuiRadio::Style{
        ...
        GuiRadio::Button::Style{
            ...
            GuiWidget::Style{
                ...
                GuiStyle(GuiStyle::Background(8, BACKGROUND_COLOR_HOVER), NO_BORDER, NO_OUTLINE, GuiStyle::Text(COLOR_BLACK), TEXT_COLOR_FOCUS),
                GuiStyle(GuiStyle::Background(8, BACKGROUND_COLOR_FOCUS), NO_BORDER, NO_OUTLINE, GuiStyle::Text(COLOR_BLACK), TEXT_COLOR_FOCUS),
    ...
    checkbox = GuiCheckbox::Style{
        ...
        GuiCheckbox::Button::Style{
            ...
            GuiWidget::Style{
                ...
                GuiStyle(GuiStyle::Background(BACKGROUND_COLOR_HOVER), NO_BORDER, NO_OUTLINE, GuiStyle::Text(COLOR_BLACK), GuiStyle::Function(TEXT_COLOR_FOCUS)),
                GuiStyle(GuiStyle::Background(BACKGROUND_COLOR_FOCUS), NO_BORDER, NO_OUTLINE, GuiStyle::Text(COLOR_BLACK), GuiStyle::Function(TEXT_COLOR_FOCUS)),
    ...
    progressCircle = GuiProgressCircle::Style{
        ...
        GuiWidget::Style{
            ...
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, TEXT_COLOR_NORMAL, GuiStyle::Function(BACKGROUND_P_COLOR_HOVER, BACKGROUND_COLOR_NORMAL)),
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, TEXT_COLOR_NORMAL, GuiStyle::Function(BACKGROUND_P_COLOR_HOVER, BACKGROUND_COLOR_NORMAL)),
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, TEXT_COLOR_DISABLED, GuiStyle::Function(BORDER_COLOR_DISABLED, BACKGROUND_COLOR_NORMAL)),
    ...
    scrollbar = GuiScrollBar::Style{
        ...
        GuiSlider::Style{
            ...
            GuiWidget::Style{
                ...
                GuiStyle(BACKGROUND_FOCUS, NO_BORDER, NO_OUTLINE, TEXT_COLOR_HOVER, FUNCTION_COLOR_DEFAULT),
                GuiStyle(BACKGROUND_FOCUS, NO_BORDER, NO_OUTLINE, TEXT_COLOR_FOCUS, FUNCTION_COLOR_DEFAULT),
    ...
    slider = GuiSlider::Style{
        ...
        // Bar
        GuiWidget::Style{
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, COLOR_BLACK, BACKGROUND_COLOR_FOCUS),
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, COLOR_BLACK, BACKGROUND_COLOR_FOCUS),
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, COLOR_BLACK, BACKGROUND_COLOR_FOCUS),
            GuiStyle(NO_BACKGROUND, NO_BORDER, NO_OUTLINE, COLOR_BLACK, BACKGROUND_COLOR_HOVER),
    ...
    textInput = GuiTextInput::Style{
        ...
        GuiWidget::Style{
            ...
            GuiStyle(NO_BACKGROUND, BORDER_NORMAL, NO_OUTLINE, TEXT_COLOR_NORMAL, BACKGROUND_COLOR_HOVER),
            GuiStyle(NO_BACKGROUND, BORDER_NORMAL, NO_OUTLINE, TEXT_COLOR_NORMAL, BACKGROUND_COLOR_HOVER),
            GuiStyle(NO_BACKGROUND, BORDER_NORMAL, NO_OUTLINE, TEXT_COLOR_DISABLED, BACKGROUND_COLOR_HOVER),
            GuiDefaults(GuiStyle::Margin(0, 0, 5, 0), GuiStyle::Padding(4), GuiAlign::TOP_LEFT, GuiUnits2D(guiPercent(100), guiWrap()))
        }
    };
}

ffw::GuiThemeFlatLight ffw::GuiThemeFlatLight::singleton;
