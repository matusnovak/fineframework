...
#define VEC2_FIX(v) ffw::Vec2f(FLOAT_FIX(v.x), FLOAT_FIX(v.y))

///=============================================================================
static ffw::Vec4f RectangleBoolean(const ffw::Vec2f& parentpos, const ffw::Vec2f& parentsize, const ffw::Vec2f& childpos, const ffw::Vec2f& childsize){
    ffw::Vec4f out;

    ffw::Vec2f parentend = parentpos + parentsize;
    ffw::Vec2f childend = childpos + childsize;
...
///=============================================================================
static float getWidgetMargin(ffw::GuiWidget* widget, const ffw::Vec2f& contentSize, int side) {
    switch(side) {
        case 0:
        case 2: {
...
///=============================================================================
void ffw::GuiWidget::realignWidgetsHorizontally(size_t start, size_t end, const ffw::Vec2f& contentSize) {
    switch(align) {
        case GuiAlign::RIGHT:
...
///=============================================================================
void ffw::GuiWidget::realignWidgetsHorizontallyEnd(size_t start, size_t end, const ffw::Vec2f& contentSize, const ffw::Vec2f& totalSize) {
    switch (align) {
        case GuiAlign::CENTER:
        case GuiAlign::LEFT:
        case GuiAlign::RIGHT: {
...
///=============================================================================
void ffw::GuiWidget::realignWidgetsVertically(size_t start, size_t end, const ffw::Vec2f& contentSize) {
    switch(align) {
        case GuiAlign::BOTTOM_CENTER:
        case GuiAlign::BOTTOM_LEFT:
        case GuiAlign::BOTTOM_RIGHT: {
...
///=============================================================================
void ffw::GuiWidget::realignWidgetsVerticallyEnd(size_t start, size_t end, const ffw::Vec2f& contentSize, const ffw::Vec2f& totalSize) {
    switch (align) {
        case GuiAlign::TOP_CENTER:
        case GuiAlign::CENTER:
        case GuiAlign::BOTTOM_CENTER: {
...
void ffw::GuiWidget::arrangeWidgetsHorizontal(GuiWidget* ptr) {
    ffw::Vec2f contentSize = getVisibleContentSize();
...
///=============================================================================
void ffw::GuiWidget::update(const ffw::Vec2f& parentpos, const ffw::Vec2f& parentsize, const GuiUserInput& input, ffw::Vec2f mousepos, bool mouseout){    
    (void)parentpos;
    (void)parentsize;
...
///=============================================================================
void ffw::GuiWidget::traverseBackground(const ffw::Vec2f& p, const ffw::Vec2f& s){
...
///=============================================================================
void ffw::GuiWidget::renderComponent(const ffw::Vec2f& p, const ffw::Vec2f& s, const ffw::GuiStyle* style) {
...
///=============================================================================
void ffw::GuiWidget::render(const ffw::Vec2f& clippos, const ffw::Vec2f& clipsize, const ffw::Vec2f& off, bool clear){
    if (sizeReal.x <= 0 || sizeReal.y <= 0)return;
    if (flags.hidden)return;
    
    auto posRealOffset = off + posReal;
    ffw::Vec4f cliparea = RectangleBoolean(clippos, clipsize, posRealOffset, sizeReal);
    ffw::Vec2f childclippos(cliparea.x, cliparea.y);
    ffw::Vec2f childclipsize(cliparea.z, cliparea.w);
...
ffw::Vec2f ffw::GuiWidget::getVisibleContentSize() const {
    ffw::Vec2f contentSize = sizeReal;
...
///=============================================================================
void ffw::GuiWidget::setOffset(const ffw::Vec2f off){
    offset.set(off);
    redraw();
}
...
///=============================================================================
void ffw::GuiWidget::eventPos(const ffw::Vec2f& pos) {
    (void)pos;
}
void ffw::GuiWidget::eventSize(const ffw::Vec2f& size) {
    (void)size;
}
...
void ffw::GuiWidget::eventMouse(const ffw::Vec2f& mousePos) {
    (void)mousePos;
}
bool ffw::GuiWidget::eventScroll(const ffw::Vec2f& scroll) {
    (void)scroll;
    return false;
}
void ffw::GuiWidget::eventMouseButton(ffw::MouseButton button, ffw::Mode mode) {
    (void)button;
    (void)mode;
}
...
void ffw::GuiWidget::eventKey(ffw::Key key, ffw::Mode mode) {
    (void)key;
    (void)mode;
}
