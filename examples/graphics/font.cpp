...
public:
    ...
    void Render() override {
		...
		int height = 0;
		for(int i = 0; i < 8; i++){
			this->Renderer()->SetDrawColor(ffw::Rgb(255 - i*32, i*32, 0));
			this->Renderer()->DrawString(10, 10 + height, &freesans[i], "Lorem ipsum dolor sit amet, consectetur adipiscing elit.");
			...
			height += int(freesans[i].GetSizeInPixels() * 1.5f);
		}
	}
