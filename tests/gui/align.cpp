...
public:
	...
	bool Setup() override {
		...
		// Create custom style
		static ffw::GuiStyleGroup customStyle;
		customStyle.normal.background.color = ffw::Rgba(0xFF000080);
		customStyle.normal.background.type = ffw::GuiStyle::Background::Type::SIMPLE;
