...
TEST_CASE("Align to top left") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 10.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(55.0f, 10.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(10.0f, 55.0f));
}
...
TEST_CASE("Align to top right") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(20.0f, 10.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 10.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(20.0f, 55.0f));
}
...
TEST_CASE("Align to top center") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(15.0f, 10.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(60.0f, 10.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(15.0f, 55.0f));
}
...
TEST_CASE("Align to left") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 15.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(55.0f, 15.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(10.0f, 60.0f));
}
...
TEST_CASE("Align to right") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(20.0f, 15.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 15.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(20.0f, 60.0f));
}
...
TEST_CASE("Align to center") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(15.0f, 15.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(60.0f, 15.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(15.0f, 60.0f));
}
...
TEST_CASE("Align to bottom left") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 20.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(55.0f, 20.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(10.0f, 65.0f));
}
...
TEST_CASE("Align to bottom right") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(20.0f, 20.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 20.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(20.0f, 65.0f));
}
...
TEST_CASE("Align to bottom center") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(15.0f, 20.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(60.0f, 20.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(15.0f, 65.0f));
}
...
TEST_CASE("Align to top left vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 10.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(10.0f, 55.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(55.0f, 10.0f));
}
...
TEST_CASE("Align to top right vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(65.0f, 10.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 55.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(110.0f, 10.0f));
}
...
TEST_CASE("Align to left vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 15.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(10.0f, 60.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(55.0f, 15.0f));
}
...
TEST_CASE("Align to right vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(65.0f, 15.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 60.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(110.0f, 15.0f));
}
...
TEST_CASE("Align to bottom left vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(10.0f, 20.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(10.0f, 65.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(55.0f, 20.0f));
}
...
TEST_CASE("Align to bottom right vertical") {
    ...
    CHECK(first->getRealPos() == ffw::Vec2f(65.0f, 20.0f));
    CHECK(second->getRealPos() == ffw::Vec2f(65.0f, 65.0f));
    CHECK(third->getRealPos() == ffw::Vec2f(110.0f, 20.0f));
}
