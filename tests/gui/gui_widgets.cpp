...
TEST_CASE("Gui Button") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(button->getRealSize() == ffw::Vec2f(100.0f, 12.0f));
...
TEST_CASE("Gui Checkbox") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(button->getRealSize() == ffw::Vec2f(100.0f, 16.0f));
    REQUIRE(button->hasFocus() == false);
    REQUIRE(button->hasHover() == false);
...
TEST_CASE("Gui Label") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(label->getRealSize() == ffw::Vec2f(100.0f, 12.0f));
...
TEST_CASE("Gui List") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(itemOne->getRealSize() == ffw::Vec2f(86.0f, 12.0f));
    REQUIRE(itemTwo->getRealSize() == ffw::Vec2f(86.0f, 12.0f));
    REQUIRE(itemThree->getRealSize() == ffw::Vec2f(86.0f, 12.0f));

    REQUIRE(list->getInner()->getRealSize() == ffw::Vec2f(86.0f, 36.0f));

    REQUIRE(list->getRealSize() == ffw::Vec2f(100.0f, 36.0f));
...
TEST_CASE("Gui Progress Bar") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(progressbar->getRealSize() == ffw::Vec2f(100.0f, 8.0f));
...
TEST_CASE("Gui Progress Circle") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(progressbar->getRealSize() == ffw::Vec2f(100.0f, 70.0f));
    REQUIRE(progressbar->hasFocus() == false);
    REQUIRE(progressbar->hasHover() == false);
    REQUIRE(gui.renderCounter() == 2);
    gui.clearCounter();
...
TEST_CASE("Gui Radio") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(radioA->getRealSize() == ffw::Vec2f(100.0f, 16.0f));
    REQUIRE(radioA->hasFocus() == false);
    REQUIRE(radioA->hasHover() == false);
    REQUIRE(radioB->getRealSize() == ffw::Vec2f(100.0f, 16.0f));
    REQUIRE(radioB->hasFocus() == false);
    REQUIRE(radioB->hasHover() == false);
    REQUIRE(radioC->getRealSize() == ffw::Vec2f(100.0f, 16.0f));
...
TEST_CASE("Gui Slider") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(slider->getRealSize() == ffw::Vec2f(100.0f, 16.0f));
    REQUIRE(slider->hasFocus() == false);
    REQUIRE(slider->hasHover() == false);

    REQUIRE(slider->getValue() == Approx(50.0f));
    REQUIRE(slider->getRange() == ffw::Vec2f(0.0f, 100.0f));
...
TEST_CASE("Gui Scrollbar") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(scrollbar->getRealSize() == ffw::Vec2f(100.0f, 12.0f));
    REQUIRE(scrollbar->hasFocus() == false);
    REQUIRE(scrollbar->hasHover() == false);

    REQUIRE(scrollbar->getValue() == Approx(50.0f));
    REQUIRE(scrollbar->getRange() == ffw::Vec2f(0.0f, 100.0f));

    REQUIRE(scrollbar->getButtonFirst()->getRealSize() == ffw::Vec2f(12.0f, 12.0f));
    REQUIRE(scrollbar->getButtonSecond()->getRealSize() == ffw::Vec2f(12.0f, 12.0f));
    REQUIRE(scrollbar->getSlider()->getRealSize() == ffw::Vec2f(100.0f - 24.0f, 12.0f));
    ...
    REQUIRE(scrollbar->getRealSize() == ffw::Vec2f(100.0f, 24.0f));
    REQUIRE(scrollbar->getButtonFirst()->getRealSize() == ffw::Vec2f(24.0f, 24.0f));
    REQUIRE(scrollbar->getButtonSecond()->getRealSize() == ffw::Vec2f(24.0f, 24.0f));
    REQUIRE(scrollbar->getSlider()->getRealSize() == ffw::Vec2f(100.0f - 48.0f, 24.0f));
}
...
TEST_CASE("Gui Switch") {
    ...
    TEST_UPDATE_AND_RENDER;
    REQUIRE(button->getRealSize() == ffw::Vec2f(16.0f, 8.0f));
    REQUIRE(button->hasFocus() == false);
    REQUIRE(button->hasHover() == false);
