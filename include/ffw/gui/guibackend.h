...
namespace ffw {
	...
	public:
		...
		virtual void drawString(const ffw::Vec2f& pos, const ffw::GuiFont* font, const std::wstring::value_type* str, size_t length, const ffw::Color& color, float lineHeight = 1.25f) const = 0;
		...
		inline void drawString(const ffw::Vec2f& pos, const ffw::GuiFont* font, const std::wstring& str, const ffw::Color& color, float lineHeight = 1.25f) const {
		...
		virtual void drawStringAligned(const ffw::Vec2f& pos, const ffw::Vec2f& size, const ffw::GuiFont* font, ffw::GuiStyle::Align align, const std::wstring& str, const ffw::GuiStyle::Text& text, float lineHeight = 1.25f) const;
	};
}
#endif
